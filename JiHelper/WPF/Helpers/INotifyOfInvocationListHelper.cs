...
namespace Jisons
{
    public static class INotifyOfInvocationListHelper
    {
        ...
        static bool JudgeAddEventHandler<T>(this object data, Delegate handler, bool isINotifyCollectionChanged)
        {
        ...
        static bool JudgeRemoveEventHandler<T>(this object data, object remove_targetdata, bool isINotifyCollectionChanged)
        {
            if (data == null)
            {
                return false;
